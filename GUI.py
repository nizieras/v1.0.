...
class ButtonFrame(customtkinter.CTkScrollableFrame):
    def __init__(self, textframe, master, **kwargs, ):
...
class TextFrame(customtkinter.CTkScrollableFrame):
    def __init__(self, master, **kwargs):
        ...
        width = 460
        self.header = customtkinter.CTkTextbox(master=self, width=width)
        self.header.grid(row=1, column=0, padx=4, pady=(4, 4), sticky=sticky)
        # self.header.insert("0.0", "hello")
        self.header.focus_set()

        self.main_text = customtkinter.CTkTextbox(master=self, width=width)
        self.main_text.grid(row=2, column=0,  padx=4, pady=(4, 4), sticky=sticky)
        ...
        self.links = customtkinter.CTkTextbox(master=self, width=width)
        self.links.grid(row=3, column=0, padx=4, pady=(4, 4), sticky=sticky)

        # массив пояснений????7?
        self.links_creation_explanation = customtkinter.CTkTextbox(master=self, width=width)
        ...
        self.tags = customtkinter.CTkTextbox(master=self, width=width)
        ...
        self.sources = customtkinter.CTkTextbox(master=self, width=width)
        self.sources.grid(row=6, column=0, padx=4, pady=(4, 4), sticky=sticky)

        self.excerpts = customtkinter.CTkTextbox(master=self, width=width)
    ...
    def update_data_in_text_box(self, note_object = note):
        ...
        if(note_object.get_list_of_note_tag(current_db)!= None):
            text_frame.tags.insert("0.0", note_object.get_list_of_note_tag(current_db))
...
class MenuFrame(customtkinter.CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        self.delete_button = customtkinter.CTkButton(master=master, width=50, height=7, command=self.button_del_call,
                                                     text="Удалить заметку", hover=True, anchor="center")
        self.delete_button.configure(fg_color = "#FF8300")
        self.delete_button.configure(hover_color="#BF7930")
        self.delete_button.grid(row=1, column=0, padx=7, pady=7, sticky="nsew")

        self.add_button = customtkinter.CTkButton(master=master, width=50, height=7, command=self.button_add_call,
                                                     text="Добавить заметку", hover=True, anchor="center")
        self.add_button.configure(fg_color = "#FF8300")
        self.add_button.configure(hover_color="#BF7930")
        self.add_button.grid(row=1, column=1, padx=7, pady=7, sticky="nsew")
...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        global button_frame
        button_frame = ButtonFrame(self.my_text_frame, master=self, width=0, height=0)
